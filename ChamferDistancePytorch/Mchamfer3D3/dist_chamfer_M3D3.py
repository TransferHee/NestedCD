...
chamfer_found = importlib.find_loader("mchamfer_3D3") is not None
if not chamfer_found:
    ...
    chamfer_3DM3 = load(name="mchamfer_3D3",
                      sources=[
...
class chamfer_3DFunction(Function):
    ...
    def forward(ctx, xyz1, xyz2):
        ...
        chamfer_3DM3.forward(xyz1, xyz2, dist1, dist2, idx1, idx2)
