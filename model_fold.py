...
class FoldEncoder(nn.Module):
    def __init__(self, args):
        ...
        self.mlp2 = nn.Sequential(
            nn.Conv1d(256, argument['feat_dims'], 1),
            nn.ReLU(),
    ...
    def forward(self, pts):
        ...
        x = self.graph_layer(local_feature, idx)  # (batch_size, 64, num_points) -> (batch_size, 1024, num_points)
...
class FoldDecoder(nn.Module):
    def __init__(self, args, seg_class=0):
        ...
        self.meshgrid = [[-0.3, 0.3, 64], [-0.3, 0.3, 32]]
...
class FoldBiasDecoder(nn.Module):
    def __init__(self, args, seg_class=0):
        ...
        self.seg_class = seg_class
        self.m = args['parameter']['num_points']  # 45 * 45.
        self.shape = argument['shape']
